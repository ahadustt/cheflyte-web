    ...
    <Card className="w-full max-w-md mx-auto p-8">
      <div className="space-y-8">
        <div className="text-center space-y-2">
          <h1 className="text-h1 font-display text-gray-900">Join Cheflyte</h1>
          <p className="text-body text-gray-600">Create your account to get started</p>
        </div>
        ...
        <div className="space-y-6">
          ...
          <form onSubmit={handleEmailSignUp} className="space-y-6">
            ...
            <Input
              ...
              errorText={password && confirmPassword && password !== confirmPassword ? 'Passwords do not match' : undefined}
              successText={password && confirmPassword && password === confirmPassword ? 'Passwords match' : undefined}
            />
        ...
        <div className="text-center text-sm">
          ...
          <a href="/auth/signin" className="text-blue-600 font-medium hover:underline transition-colors">
            Sign in
          </a>
        </div>
      </div>
